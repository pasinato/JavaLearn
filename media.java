...
//Calcolare la media di un elenco di voti non negativi relativi a un esame,
//Ripete il calcolo per più esami fino a quando l'utente non chiede di fermarsi.

public class media{
  public static void main(String[] args){

    System.out.println("Questo programma calcola la media di un elenco di non negativi");
    double somma;
    int numeroStudenti;
    double successivo;
    String risposta;
